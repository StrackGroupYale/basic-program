...
formattable(swapvisualize, align=c("l"),
            list(Trade_Partner=formatter("span",style = ~ style(font.weight="bold")),
            area(col=2:ncol(swapvisualize)) ~ color_tile("blue","red")))

formattable(ineffdens, align=c("l"), list(player=formatter("span",style = ~ style(font.weight="bold")),
                                          area(row=2:2)) ~ color_tile("red","white"))

formattable(probswap, align=c("l"), list(player=formatter("span",style = ~ style(font.weight="bold")),
                                          area(row=2:2)) ~ color_tile("red","white"))
