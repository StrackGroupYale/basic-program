...
o = Main.x_t.welfare(i[1],i[3],i[2],i[4],"solver/assignment_data",0,1,1,0,"constrained")
print("CONSTRAINED ",o)
...
o2 = Main.x_t.welfare(i2[1],i2[3],i2[2],i2[4],"solver/assignment_data",0,1,1,0,"unconstrained")
